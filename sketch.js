...
function setup() {
  ...
  mnky = createSprite(100,340,20,50);
...
function draw() {
  ...
  back.x=back.width/2;
    ...
    if(FoodGroup.isTouching(mnky)){
      FoodGroup.destroyEach();
    score = score + 2;
    }
    switch(score){
        case 10: mnky.scale=0.12;
                break;
        case 20: mnky.scale=0.14;
                break;
        case 30: mnky.scale=0.16;
                break;
        case 40: mnky.scale=0.18;
                break;
        default: break;
    }
